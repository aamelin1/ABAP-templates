---
title: "Отчёты ALV PIVB — свой pivot-отчёт на CDS"
keywords: PIVB, pivot, сводный отчёт, PIVB_CATALOG, PIVB_SELECT_AND_DISPLAY, PIVB_F4, PIVB_CONV_RANGE_TO_SELTAB, PIVB_SQL_GET_CLAUSE, IF_EX_PIVB, BAdI PIVB, RFPIVB_EX_SFLIGHT_01, Note 2100879, FAGLL03H
status: ok
---

# Отчёты ALV PIVB — свой pivot-отчёт на CDS
